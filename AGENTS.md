...
- **Resplandor del Hero suavizado y posicionado:** Se movió el orbe de fondo del Hero a la esquina superior derecha (`top: -16%`, `left: 78%` en desktop) mediante variables CSS responsivas. Se corrigió el parpadeo de reinicio de loop en la animación infinite ajustando los keyframes de entrada y salida para que coincidan exactamente en opacidad (`0.07 -> 0.15 -> 0.07`) y escala (`0.96 -> 1.04 -> 0.96`), logrando una pulsación constante y fluida.
