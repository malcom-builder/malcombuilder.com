...
export function ProjectMockup({ slug }: Props) {
  ...
  if (!projectMockup) {
    ...
    return (
      <section className="section" style={{ paddingBlock: "2rem", borderBottom: "1px solid var(--color-border)" }}>
  ...
  return (
    <section className="section" style={{ paddingBlock: "3rem", borderBottom: "1px solid var(--color-border)", overflow: "hidden" }}>
      <div className="container">
