...
const btnBackClass = "px-6 py-3 bg-transparent border border-[var(--color-border)] hover:border-[var(--color-fg)]/60 hover:text-[var(--color-fg)] rounded-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_15px_rgba(255, 255, 255,0.15)] active:scale-[0.98] active:shadow-[inset_0_2px_8px_rgba(255, 255, 255,0.25)] flex items-center gap-2 text-sm font-semibold cursor-pointer text-[var(--color-muted)] font-body btn-glow-trigger";
const btnNextClass = "px-8 py-3 bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] text-[var(--color-bg)] font-bold rounded-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(255, 255, 255,0.25)] active:scale-[0.98] active:shadow-[inset_0_2px_8px_rgba(255, 255, 255,0.25)] flex items-center gap-2 text-sm cursor-pointer shadow-[var(--btn-shadow)] disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-none font-body btn-glow-trigger";
const optSelectedClass = "p-4 text-left rounded-xl border text-sm transition-all duration-200 active:scale-[0.98] active:shadow-[inset_0_2px_8px_rgba(255, 255, 255,0.25)] cursor-pointer bg-[var(--color-accent)]/10 border-[var(--color-accent)] text-[var(--color-fg)] font-medium shadow-[0_0_15px_rgba(var(--spotlight-color),0.08)] font-body";
const optUnselectedClass = "p-4 text-left rounded-xl border text-sm transition-all duration-200 active:scale-[0.98] active:shadow-[inset_0_2px_8px_rgba(255, 255, 255,0.25)] cursor-pointer bg-[var(--color-surface)] border-[var(--color-border)] hover:border-[var(--color-fg)]/30 text-[var(--color-muted)] hover:text-[var(--color-fg)] font-body";
      ...
      {step > 0 && step < 6 && (
        <div className="mb-6 sm:mb-10 space-y-3 sm:space-y-4">
          <div className="flex justify-between items-center text-xs font-mono text-[var(--color-muted)]">
            <span className="text-[var(--color-fg)] font-semibold">{t.steps.step} {step} {t.steps.de} {TOTAL_STEPS}</span>
            <span className="text-[var(--color-fg)]">{getProgressPercent()}% {t.steps.completado}</span>
          </div>
          <div className="w-full h-1.5 bg-[var(--color-border)] rounded-full overflow-hidden relative">
            <motion.div
              className="h-full bg-[var(--color-fg)] shadow-[0_0_12px_rgba(255, 255, 255,0.6)]"
              initial={{ width: 0 }}
        ...
        {step === 0 && (
          ...
          >
            <div className="space-y-4 relative">
              <div className="inline-flex items-center gap-2 px-3 py-1 text-xs font-mono text-[var(--color-fg)] border border-[var(--color-border)] rounded-full bg-[var(--color-surface)] mx-auto">
                <Sparkle className="w-3.5 h-3.5 animate-pulse text-[var(--color-fg)]" />
                {t.steps.time}
              </div>
             ...
             <div className="pt-10 flex justify-center relative">
              ...
              >
                <motion.span
                  ...
                  className="inline-flex items-center justify-center px-10 py-5 bg-white text-black font-bold text-lg sm:text-xl rounded-lg cursor-pointer hover:shadow-[0_0_30px_rgba(255, 255, 255,0.25)] active:shadow-[inset_0_2px_8px_rgba(255, 255, 255,0.25)] select-none transition-shadow duration-300 btn-glow-trigger"
                >
                  {t.steps.comenzar}
                </motion.span>
              </button>
