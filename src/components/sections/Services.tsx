  ...
  return (
    <div className="py-12 md:py-20 border-b border-[var(--color-border)] last:border-b-0 grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 items-start">
      ...
      <div className="md:col-span-4 flex flex-col gap-2">
        <span className="font-mono text-sm tracking-widest text-[var(--color-fg)] font-bold">{numberStr}</span>
      ...
      <div className="container">
        <FadeIn>
          <div style={{ marginBottom: "1rem" }}>
            <span className="label font-mono" style={{ display: "inline-block", color: "var(--color-fg)" }}>
              {t("badge")}
            </span>
          </div>
