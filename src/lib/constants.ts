...
export const projects: Project[] = [
  ...
  { id: '04', slug: 'smartwallet',              category: 'Fintech',            title: 'SmartWallet',             metric: 'Double-Entry',   url: 'https://github.com/malcom-builder/SmartWallet',    github: 'https://github.com/malcom-builder/SmartWallet',    techStack: ['.NET 8', 'SQL Server', 'Azure', 'Docker'], spotlightImage: '/images/projects/smart-wallet/hero.webp' },
