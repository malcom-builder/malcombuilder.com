...
export const projects: Project[] = [
  ...
  { id: '04', slug: 'smartwallet',              category: 'Fintech',            title: 'SmartWallet',             metric: 'Double-Entry',   url: 'https://smartwallet.malcombuilder.com',    techStack: ['.NET 8', 'SQL Server', 'Azure', 'Docker'], spotlightImage: '/images/projects/smart-wallet/hero.webp' },
