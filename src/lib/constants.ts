...
export const projects: Project[] = [
  ...
  { id: '03', slug: 'authmotion',               category: 'IAM System',         title: 'AuthMotion',              metric: 'Open Source',    url: 'https://authmotion.malcombuilder.com',    techStack: ['.NET 10', 'SQL Server', 'Docker', 'EF Core'], spotlightImage: '/images/projects/auth-motion/auth-motion-spotlight.webp' },
  { id: '04', slug: 'smartwallet',              category: 'Fintech',            title: 'SmartWallet',             metric: 'Double-Entry',   url: 'https://github.com/malcom-builder/SmartWallet',    github: 'https://github.com/malcom-builder/SmartWallet',    techStack: ['.NET 8', 'SQL Server', 'Azure', 'Docker'], spotlightImage: '/images/projects/smart-wallet/dashboard.webp' },
