...
export const projects: Project[] = [
  ...
  { id: '03', slug: 'authmotion',               category: 'IAM System',         title: 'AuthMotion',              metric: 'Open Source',    url: 'https://github.com/malcom-builder/AuthMotion',    github: 'https://github.com/malcom-builder/AuthMotion',    techStack: ['.NET 10', 'SQL Server', 'Docker', 'EF Core'], spotlightImage: '/images/projects/auth-motion/auth-motion-spotlight.webp' },
